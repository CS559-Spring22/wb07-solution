...
/** @type {T.BoxBufferGeometry} */ const box = new T.BoxBufferGeometry();
...
/** @type {T.SphereBufferGeometry} */ const sphere = new T.SphereBufferGeometry();
/** @type {T.SphereBufferGeometry} */ const quarterSphere = new T.SphereBufferGeometry(1, 20, 20, 0, Math.PI / 2, 0, Math.PI);
/** @type {T.CylinderBufferGeometry} */ const cylinder = new T.CylinderBufferGeometry();
...
/** @type {T.LatheBufferGeometry} */ const lathe = new T.LatheBufferGeometry(points, 40);
...
/** @type {T.SphereBufferGeometry} */ const semiSphere = new T.SphereBufferGeometry(1, 20, 20, 0, Math.PI, Math.PI * 2, Math.PI);
// Bowl group
